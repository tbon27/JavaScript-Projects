...
function get_todos() {
  ...
  //if the input is not null the JSON.parse will communicate with
  //the web broswer to make the task a Javascript object
  if (todos_str !== null) {
...
//this function adds the inputed tsask to get_todos function array
function add() {
...
function show() {
  //this sets the taswk that was retrieved as a variable
  var todos = get_todos();
