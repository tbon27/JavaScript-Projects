...
function placeXOrO(squareNumber) {
  ...
  if (!selectedSquares.some((element) => element.includes(squareNumber))) {
    //this var retrieves the html element id that was clciked
    ...
    //squareNumber and active Player are concantenated together and added to array
...
function checkWinConditions() {
  ...
  //This condition checks for a tie. If none of the above condition register and 9 squares are selected the code executes
  else if (selectedSquares.length >= 9) {
    //This function plays the tie game sound
    audio("./media/TOASTY-tie.mp3");
  ...
  function arrayIncludes(squareA, squareB, squareC) {
    ...
    //if the 3 variables we pass are all inclueded in our array true is rerturned and our else if condition executes the drawWinLine function
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
  ...
  let x1 = coordX1,
    ...
    y1 = coordY1,
    //this line indictess where the end of a lines x axis is
    x2 = coordX2,
  ...
  function animateLineDrawing() {
    ...
    if (x1 <= x2 && y1 <= y2) {
      ...
      //this condition adds 10 to previeous end y point
      if (y < y2) {
        y += 10;
      }
      //this condition cancels our anim loop if we've reached the end points
      if (x >= x2 && y >= y2) {
  ...
  function clear() {
    //this line starts our animationloop
...
function resetGame() {
  ...
  for (let i = 0; i < 9; i++) {
    //this var gets the html elemnt of i
